...
data = pd.read_csv(sys.argv[1], names=['boardtime', 'temp', 'humidity', 'timestamp', 'lat', 'lon', 'altitude', 'fixtype', 'satellites'])
...
seconds_taken = round((data['boardtime'].iloc[-1] - data['boardtime'].iloc[0]) / 1000 + 3)
